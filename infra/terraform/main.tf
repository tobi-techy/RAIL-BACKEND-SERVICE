...
resource "aws_ecs_task_definition" "app" {
  ...
  container_definitions = jsonencode([{
    ...
    secrets = [
      ...
      { name = "REFLECT_BASE_URL",      valueFrom = "/rail/${local.env}/REFLECT_BASE_URL" },
      { name = "REFLECT_SOLANA_RPC",    valueFrom = "/rail/${local.env}/REFLECT_SOLANA_RPC" },
      { name = "REFLECT_ENABLE_TREASURY_SWEEP", valueFrom = "/rail/${local.env}/REFLECT_ENABLE_TREASURY_SWEEP" },
      { name = "REFLECT_MIN_SWEEP_AMOUNT", valueFrom = "/rail/${local.env}/REFLECT_MIN_SWEEP_AMOUNT" },
      { name = "REFLECT_ALLOWED_PROGRAM_IDS", valueFrom = "/rail/${local.env}/REFLECT_ALLOWED_PROGRAM_IDS" },
      ...
      { name = "CENCORI_API_KEY",       valueFrom = "/rail/${local.env}/CENCORI_API_KEY" },
      { name = "CENCORI_MODEL",         valueFrom = "/rail/${local.env}/CENCORI_MODEL" },
