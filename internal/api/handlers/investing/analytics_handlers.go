...
func (h *AnalyticsHandlers) GetPerformanceMetrics(c *gin.Context) {
	...
	if err != nil {
		...
		common.RespondInternalError(c, "Failed to get performance metrics")
		return
	}
...
func (h *AnalyticsHandlers) GetRiskMetrics(c *gin.Context) {
	...
	if err != nil {
		...
		common.RespondInternalError(c, "Failed to get risk metrics")
		return
	}
...
func (h *AnalyticsHandlers) GetDiversificationAnalysis(c *gin.Context) {
	...
	if err != nil {
		...
		common.RespondInternalError(c, "Failed to get diversification analysis")
		return
	}
...
func (h *AnalyticsHandlers) TakeSnapshot(c *gin.Context) {
	...
	if err := h.analyticsService.TakeSnapshot(c.Request.Context(), userID); err != nil {
		...
		common.RespondInternalError(c, "Failed to take snapshot")
		return
	}
...
func (h *AnalyticsHandlers) GetPortfolioHistory(c *gin.Context) {
	...
	if !validPeriods[period] {
		common.RespondBadRequest(c, "Invalid period. Valid values: 1D, 1W, 1M, 3M, 6M, 1Y, ALL")
		return
	}
	...
	if err != nil {
		...
		common.RespondInternalError(c, "Failed to get portfolio history")
		return
	}
...
func (h *AnalyticsHandlers) GetDashboard(c *gin.Context) {
	...
	if err != nil {
		...
		common.RespondInternalError(c, "Failed to get portfolio dashboard")
		return
	}
