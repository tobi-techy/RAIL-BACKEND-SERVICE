...
type Container struct {
	...
	// Investment (Glider) Services — the deterministic investment engine the
	// Miriam agent drives over the Agent API.
	InvestmentGliderService     *investmentsvc.Service
	InvestmentSyncWorker        *investmentsync.Worker
	InvestmentAssetRepo         *repositories.InvestmentAssetRepository
	InvestmentStrategyRepo      *repositories.InvestmentStrategyRepository
	InvestmentEnrollmentRepo    *repositories.InvestmentEnrollmentRepository
	InvestmentHoldingRepo       *repositories.InvestmentHoldingRepository
	InvestmentExecutionRepo     *repositories.InvestmentExecutionRepository
	InvestmentFundingRepo       *repositories.InvestmentFundingTransferRepository
	InvestmentSignatureRepo     *repositories.InvestmentSignatureRequestRepository
	InvestmentConfirmationRepo  *repositories.InvestmentConfirmationRepository
	InvestmentOperationRepo     *repositories.InvestmentOperationRepository
