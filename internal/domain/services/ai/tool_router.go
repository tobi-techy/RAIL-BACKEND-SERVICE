...
var toolCategoryMap = map[ToolCategory]map[string]bool{
	...
	CategoryPlanning: {
		...
		aitools.ToolGetConsciousSpendingPlan:    true,
		aitools.ToolBuildConsciousSpendingPlan:  true,
		aitools.ToolCommitConsciousSpendingPlan: true,
		aitools.ToolPauseConsciousSpendingPlan:  true,
	},
	CategoryHistory: {
		ToolGetRecentTransactions: true,
