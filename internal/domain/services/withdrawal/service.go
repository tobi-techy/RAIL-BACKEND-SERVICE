...
var circleChainToChainRails = map[string]struct{ chain, token string }{
	...
	"SOL-DEVNET":   {"SOL_TESTNET", "4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU"},
	...
	"MATIC-AMOY":   {"POLYGON_MAINNET", "0x41E94Eb019C0762f9Bfcf9Fb1E58725BfB0e7582"}, // no testnet
...
var destChainToChainRails = map[string]string{
	"SOL": "SOL_MAINNET", "SOL-DEVNET": "SOL_TESTNET", "SOLANA": "SOL_MAINNET",
	"ETH": "ETH_MAINNET", "ETH-SEPOLIA": "ETH_TESTNET", "ETHEREUM": "ETH_MAINNET",
	...
	"MATIC": "POLYGON_MAINNET", "MATIC-AMOY": "POLYGON_MAINNET", "POLYGON": "POLYGON_MAINNET",
