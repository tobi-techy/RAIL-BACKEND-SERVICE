...
type LedgerIntegration interface {
	...
	RecordDepositWithAllocation(ctx context.Context, userID uuid.UUID, amount decimal.Decimal, depositID uuid.UUID, depositType, transactionRef string, spendingAmount, stashAmount decimal.Decimal) error
